...
const M = {
  da: {
    ...
    meet: {
      ...
      geoFound: "✓ Adresse fundet — nål sat og vejr slået til.",
  ...
  en: {
    ...
    meet: {
      ...
      geoFound: "✓ Address found — pin set and weather enabled.",
  ...
  de: {
    ...
    meet: {
      ...
      geoFound: "✓ Adresse gefunden — Nadel gesetzt und Wetter aktiviert.",
