...
const M = {
  da: {
    ...
    nav: {
      ...
      uploadPhotos: "Upload billeder", leaderboard: "Leaderboard", parts: "Reservedelskatalog", admin: "Admin",
    ...
    meet: {
      ...
      geoFound: "✓ Adresse fundet — nål sat, kort-link udfyldt og vejr slået til.",
      geoNotFound: "Adressen blev ikke fundet — sæt nålen manuelt på kortet.",
  ...
  en: {
    ...
    nav: {
      ...
      uploadPhotos: "Upload photos", leaderboard: "Leaderboard", parts: "Parts catalog", admin: "Admin",
    ...
    meet: {
      ...
      geoFound: "✓ Address found — pin set, map link filled in and weather enabled.",
      geoNotFound: "Address not found — drop the pin manually on the map.",
  ...
  de: {
    ...
    nav: {
      ...
      uploadPhotos: "Fotos hochladen", leaderboard: "Bestenliste", parts: "Ersatzteilkatalog", admin: "Admin",
    ...
    meet: {
      ...
      geoFound: "✓ Adresse gefunden — Nadel gesetzt, Karten-Link ausgefüllt und Wetter aktiviert.",
      geoNotFound: "Adresse nicht gefunden — Nadel manuell auf der Karte setzen.",
