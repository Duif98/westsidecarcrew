...
const M = {
  da: {
    ...
    nav: {
      ...
      uploadPhotos: "Upload billeder", leaderboard: "Leaderboard", admin: "Admin",
    ...
    car: {
      ...
      fEngine: "Motor", fDrivetrain: "Drivlinje", fMods: "Modifikationer",
  ...
  en: {
    ...
    nav: {
      ...
      uploadPhotos: "Upload photos", leaderboard: "Leaderboard", admin: "Admin",
    ...
    car: {
      ...
      fEngine: "Engine", fDrivetrain: "Drivetrain", fMods: "Modifications",
  ...
  de: {
    ...
    nav: {
      ...
      uploadPhotos: "Fotos hochladen", leaderboard: "Bestenliste", admin: "Admin",
    ...
    car: {
      ...
      fEngine: "Motor", fDrivetrain: "Antrieb", fMods: "Modifikationen",
