...
const M = {
  da: {
    ...
    nav: {
      ...
      uploadPhotos: "Upload billeder", leaderboard: "Leaderboard", parts: "Reservedelskatalog", tyres: "Dæk & fælge", suspension: "Undervogn & geometri", tyrePressure: "Dæktryk & temperatur", octane: "Oktan-booster", manuals: "Manualer", dashboard: "Dashboard", myMeets: "Mine meets", feed: "Feed", messages: "Beskeder", admin: "Admin",
      more: "Mere", create: "Opret", createPhoto: "Upload billede", createMeet: "Nyt meet", profileTab: "Profil",
      sectionSocial: "Socialt", sectionCrew: "Crew", sectionTools: "Værktøj", sectionAccount: "Konto",
    ...
    hero: {
      ...
      ctaGarage: "Se garagen", ctaJoin: "Bliv en del af crewet",
    ...
    meet: {
      ...
      share: "Del meet", shareCopied: "Link kopieret ✓", shareError: "Kunne ikke dele — prøv igen",
      shareText: "Se meetet og sig om du kommer 👇",
  ...
  en: {
    ...
    nav: {
      ...
      uploadPhotos: "Upload photos", leaderboard: "Leaderboard", parts: "Parts catalog", tyres: "Tyres & wheels", suspension: "Suspension & geometry", tyrePressure: "Tyre pressure & temperature", octane: "Octane booster", manuals: "Manuals", dashboard: "Dashboard", myMeets: "My meets", feed: "Feed", messages: "Messages", admin: "Admin",
      more: "More", create: "Create", createPhoto: "Upload photo", createMeet: "New meet", profileTab: "Profile",
      sectionSocial: "Social", sectionCrew: "Crew", sectionTools: "Tools", sectionAccount: "Account",
    ...
    hero: {
      ...
      ctaGarage: "See the garage", ctaJoin: "Join the crew",
    ...
    meet: {
      ...
      share: "Share meet", shareCopied: "Link copied ✓", shareError: "Couldn't share — try again",
      shareText: "See the meet and let us know if you're coming 👇",
  ...
  de: {
    ...
    nav: {
      ...
      uploadPhotos: "Fotos hochladen", leaderboard: "Bestenliste", parts: "Ersatzteilkatalog", tyres: "Reifen & Felgen", suspension: "Fahrwerk & Geometrie", tyrePressure: "Reifendruck & Temperatur", octane: "Oktan-Booster", manuals: "Handbücher", dashboard: "Dashboard", myMeets: "Meine Meets", feed: "Feed", messages: "Nachrichten", admin: "Admin",
      more: "Mehr", create: "Erstellen", createPhoto: "Foto hochladen", createMeet: "Neues Meet", profileTab: "Profil",
      sectionSocial: "Sozial", sectionCrew: "Crew", sectionTools: "Werkzeuge", sectionAccount: "Konto",
    ...
    hero: {
      ...
      ctaGarage: "Zur Garage", ctaJoin: "Werde Teil der Crew",
    ...
    meet: {
      ...
      share: "Meet teilen", shareCopied: "Link kopiert ✓", shareError: "Teilen fehlgeschlagen — versuch es erneut",
      shareText: "Sieh dir das Meet an und sag Bescheid 👇",
